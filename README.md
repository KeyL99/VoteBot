...
* **Stance Detection**
  ...
  "reply": the commenter role of parent comments (i.e., comments that are replied to by the current comment) and child comments (i.e., comments that reply to the current comment)
