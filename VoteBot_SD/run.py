...
if __name__ == '__main__':
    ...
    for i in range(FOLDS):
        FOLD_DATA_PATH = './data/FoldData/FOLD' + str(i)
        train_data = read_json(os.path.join(FOLD_DATA_PATH, 'train.json'))
        test_data = read_json(os.path.join(FOLD_DATA_PATH, 'test.json'))

        ID = read_json_ID(os.path.join(FOLD_DATA_PATH, 'train.json'))
        ID2 = read_json_ID(os.path.join(FOLD_DATA_PATH, 'test.json'))
    ...
    print()
    print('===================  Final Result  ========================')
    print('avg P: ', total_p1 / FOLDS)
    print('avg R: ', total_r1 / FOLDS)
    print('avg F1: ', total_f1 / FOLDS)
